...
#         return {
#             "mask": mask_with_boundary,
#             "token_embedding": token_embedding.view(
#                 batch_size, sequence_length_with_boundary, -1
#             ),
#         }
...
#         cell_size,
#         go_forward=True,
#         memory_cell_clip=None,
#         hidden_state_clip=None,
#     ):
...
#             forward_layer = _LstmCellWithProjection(
#                 lstm_input_size,
#                 hidden_size,
#                 cell_size,
#                 go_forward=True,
...
#             )
#             backward_layer = _LstmCellWithProjection(
#                 lstm_input_size,
#                 hidden_size,
#                 cell_size,
#                 go_forward=False,
...
#         num_valid = (
#             torch.sum(mask[:, 0]).int().item()
#         )  # just in case some instances may be of zero length.
...
#                     self._states, unsorted_states, used_new_rows_mask
#                 ):
...
#             final_states,
#             restoration_indices,
#         ) = self._sort_and_run_forward(self._lstm_forward, inputs, mask)
...
#                     dataset = f["RNN_%s" % j_direction]["RNN"]["MultiRNNCell"][
#                         "Cell%s" % i_layer
#                     ]["LSTMCell"]
...
#             (
#                 representation_without_sentence_boudary,
#                 mask_without_sentence_boundary,
#             ) = remove_sentence_boundaries(
#                 representation_with_sentence_bounary, mask_with_sentence_boundary
#             )
#             representations.append(
#                 self._dropout(representation_without_sentence_boudary)
#             )

#         return {
#             "mask": mask_without_sentence_boundary,
